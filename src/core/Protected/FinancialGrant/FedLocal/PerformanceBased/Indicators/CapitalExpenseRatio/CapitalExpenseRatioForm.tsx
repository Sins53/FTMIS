...
interface CapitalExpenseRatioFormProps {
  toggle: () => void;
  isOpen?: boolean;
  formData: CapitalExpenseRatioInitialValueProps;
}
function CapitalExpenseRatioForm(props: CapitalExpenseRatioFormProps) {
  ...
  const { values, errors, handleChange, handleSubmit, touched, handleBlur, resetForm } = useFormik({
    ...
    onSubmit: (values: CapitalExpenseRatioInitialValueProps, { resetForm }) => {
...
export default CapitalExpenseRatioForm;
