...
function CapitalExpenseRatio() {
  ...
  const {
    ...
    initialValues: CapitalExpenseRatioInitialValue,
  ...
  return (
    <>
      {CapitalExpenseDetailsData && CapitalExpenseDetailsData?.length > 0 ? (
        <>
          <Text variant="h6" color={base.primary} typeface="semiBold" className="p-3 ">
            Capital Expense Ratio
          </Text>
          <Box className="px-3 flex-grow-1">
            <Table data={CapitalExpenseDetailsData || []} columns={columns} loading={isLoading} />
          </Box>
        </>
      ) : (
